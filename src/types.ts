...
export type Parser = Omit<Prettier.Parser<any>, "parse"> & {
...
export type Plugin = Omit<Prettier.Plugin<any>, "parsers" | "printers"> & {
...
export type Printer = Omit<Prettier.Printer<any>, "print"> & {
  print: (path: Path<any>, options: Options, print: Print) => Doc;
};
...
export type SorterRelevantKeys = {
    [key: string]: any;
};
